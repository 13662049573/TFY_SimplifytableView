...
- (void)setTfy_titleFont:(UIFont *)tfy_titleFont {
    ...
    [self.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName : (self.tfy_titleColor ? self.tfy_titleColor : [UIColor blackColor]),NSFontAttributeName : (tfy_titleFont ? tfy_titleFont : [UIFont fontWithName:@"Helvetica-Bold" size:16])}];
}
