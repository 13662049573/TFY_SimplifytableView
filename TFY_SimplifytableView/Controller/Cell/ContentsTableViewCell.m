...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self=[super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.nameLabel.tfy_LeftSpaceToView(20, self.iconImageV).tfy_TopSpace(0).tfy_RightSpace(20).tfy_Height(30);
        
        [self.back_View addSubview:self.phoneNumLabel];
        self.phoneNumLabel.tfy_LeftSpaceToView(20, self.iconImageV).tfy_TopSpaceToView(0, self.nameLabel).tfy_RightSpace(20).tfy_BottomSpace(0);
...
-(void)setModel:(TFY_PersonModel *)model{
    ...
    self.iconImageV.image = _model.image ? model.image : [[UIImage imageNamed:@"avatar_06"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
-(UIView *)back_View{
    if (!_back_View) {
        ...
        _back_View.layer.cornerRadius = 10;
    }
    return _back_View;
}
